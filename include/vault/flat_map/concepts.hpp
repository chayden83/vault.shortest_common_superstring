...
concept ForwardLayoutPolicy =
    ...
    requires(I first, I last, std::size_t n, std::size_t rank, std::ptrdiff_t idx, std::iter_value_t<I> const &key, C comp) {
...
concept BidirectionalLayoutPolicy =
    ForwardLayoutPolicy<P, I, C> &&
    requires(std::size_t n, std::ptrdiff_t idx) {
        // Reverse Traversal
